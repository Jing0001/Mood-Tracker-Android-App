...
public class FImage3 extends AppCompatActivity implements FAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addBtn2 = findViewById(R.id.addActivityBtn3);

        addBtn2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FImage3.this, FUpload3.class);
        ...
        mDBListener = mDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mAdapter.setOnItemClickListener(FImage3.this);
    ...
    public void onDeleteItemClick(int position) {
        ...
        itemRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(FImage3.this, "Activity deleted", Toast.LENGTH_SHORT).show();
            }
        });
    }
